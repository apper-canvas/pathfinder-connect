        ...
        <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center">
                <NavLink to="/" className="flex items-center space-x-3">
                    ...
                    <div>
                        <h1
                            className="text-xl font-bold bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-transparent">PathFinder Pro
                                            </h1>
            ...
            <nav className="hidden md:flex items-center space-x-1">
                {navItems.map(item => <NavLink
                    ...
                    ) => `px-4 py-2 rounded-lg font-medium transition-all duration-200 flex items-center space-x-2 ${isActive ? "bg-primary-500 text-white shadow-lg" : "text-gray-600 hover:text-primary-600 hover:bg-primary-50"}`}>
        ...
        {isMobileMenuOpen && <motion.div
            ...
            <div className="px-4 py-2 space-y-1">
                {navItems.map(item => <NavLink
                    ...
                    ) => `block px-4 py-3 rounded-lg font-medium transition-all duration-200 flex items-center space-x-3 ${isActive ? "bg-primary-500 text-white shadow-lg" : "text-gray-600 hover:text-primary-600 hover:bg-primary-50"}`}>
